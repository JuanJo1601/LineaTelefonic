class LineaTelefonica:
    ...
    # Costo de la llamada en dolares
    costoDolares = ""

    # Cantidad de dinero para gastar
    prepago = ""

    # Estrato linea telefonica
    estrato = ""

    # Descuento linea telefonica
    descuento = ""
    ...
    ----------------------------------------------------------------'''
    #
    def convertirPesosADolares(self, vDolar):
        vDolar = 3100
        self.costoLlamadas = self.costoLlamadas * vDolar
    ...
    def __init__(self):
      ...
      # Motivar al cliente, dandole 1000 por cada 30 minutos utilizados
    def motivarCliente(self):
        if (self.darNumeroMinutos > 30):
            self.darNumeroMinutos + 1000

    # Agregar dinero al saldo
    def agregarDineroSaldo(self, valor):
        nSaldo = self.prepago + valor
        return nSaldo

    # Informa la cantidad de dinero a utilizar
    ...
    def agregarLlamadaLocal(self, pMinutos):
        ...
        self.numeroMinutos = self.numeroMinutos + pMinutos
        # Suma el costo (costo por minuto: 35 pesos)
        self.costoLlamadas = self.costoLlamadas + (pMinutos * 35)
    ...
    # Retorna descuento de la linea telefonica
    def aplicarDescuento(self):
        self.costoLlamadas * self.descuento / 100
        return self.descuento
    
    # Aplica el descuento a todo
    def aplcarDescuentoATodos(self):
        dTodos = float= self.linea1.aplicarDescuento() + self.linea2.aplicarDescuento() + self.linea3.aplicarDescuento
