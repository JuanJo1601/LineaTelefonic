from test.LineaTelefonica import LineaTelefonica 
...
class Empresa: 
    ...
    def darCostoPromedioMinuto(self): 
        ...
        costoMinutos = self.darTotalCostoLlamadas() 

        totalMinutos = self.darTotalMinutos() 

        return costoMinutos / totalMinutos 
